...
public:
    ...
    inline bool isLockedByThisThread() const { return holder_ == CurrentThread::tid(); }

    inline void assertLocked() const ASSERT_CAPABILITY(this) { assert(isLockedByThisThread()); }
    ...
    inline pthread_mutex_t* getPthreadMutex() /* non-const */ { return &mutex_; }
};
